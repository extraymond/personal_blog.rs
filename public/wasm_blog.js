        ...
        try {
            ...
            const real = () => {
                ...
                try {
                    ...
                    if (--state.cnt === 0) wasm.__wbindgen_export_2.get(210)(a, state.b);
                    else state.a = a;
                }
            }
            ;
        ...
        try {
            ...
            const real = (arg0, arg1, arg2) => {
                ...
                try {
                    ...
                    if (--state.cnt === 0) {
                        wasm.__wbindgen_export_2.get(212)(state.a, state.b);
                        state.a = 0;
                    }
                }
            }
        ...
        try {
            ...
            const real = (arg0) => {
                ...
                try {
                    ...
                    if (--state.cnt === 0) wasm.__wbindgen_export_2.get(233)(a, state.b);
                    else state.a = a;
                }
            }
            ;
